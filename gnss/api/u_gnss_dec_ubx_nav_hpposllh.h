...
typedef struct {
    ...
    int8_t lonHp;    /**< high precision component of longitude; add
                          this to lon to get longitude in degrees
                          times 1e9 as follows:
                          `int64_t lon1e9 = (((int64_t) lon) * 100) + lonHp` */
    int8_t latHp;    /**< high precision component of latitude; add
                          this to lat to get latitude in degrees
                          times 1e9 as follows:
                          `int64_t lat1e9 = (((int64_t) lat) * 100) + latHp` */
    int8_t heightHp; /**< high precision component of height above
                          ellipsoid; add this to height to get
                          height in tenths of a mm as follows:
                          `int64_t height1e1 = (((int64_t) height) * 10) + heightHp` */
    int8_t hMSLHp;   /**< high precision component of height above
                          mean sea level; add this to hMSL to get
                          hMSL in tenths of a mm as follows:
                          `int64_t hMSL1e1 = (((int64_t) hMSL) * 10) + hMSLHp` */
